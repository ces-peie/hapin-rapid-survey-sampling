...
```{r clusters-density, dpi=600, fig.width=9, fig.height=6.5}
dpar <- par()
par(mar = c(2, 2, 3, 1))
plot(cluster_cells)
...
```{r clusters-services, dpi=600, fig.width=10, fig.height=7}
dpar <- par()
par(mar = c(2, 2, 3, 1))
# Base map
plot(jalapa, asp = 1)
...
```{r some-clusters, fig.width=6.5, fig.height=9, cache.rebuild=TRUE, dpi=600}
